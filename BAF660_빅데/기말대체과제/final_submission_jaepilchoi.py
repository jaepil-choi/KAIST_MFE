...
# - 거리 기반 모델의 성능 향상 및 안정성을 위해 변수 변환을 고려하는 것이 좋아 보입니다. 
...
# - 일단 DBSCAN은 군집이 1개 나와 실루엣 스코어 자체가 계산이 안되기 때문에 K Means를 선택했습니다. 
...
# ## 2. 결측값 처리
#
# 관측치 5와 6은 X값이 결측되어 있습니다. XGBoost는 결측값을 특정 노드로 보냈을 때의 이득을 계산하여 **최적의 기본 방향(default direction)**을 결정합니다.
#
